...
function getStandard() {
    ...
    if ($(".outer-section").length > 0) {
        ...
        $(".outer-section").each(function(i) {
            ...
            console.log("qdtemplate:"+"37:"+wrapper[0].getAttribute('myheight'));
      //      for(var key in wrapper){
 				// console.log('key='+key+'  wrapper[key]='+wrapper[key]);
			//}
            html += perch + '  <div class="outer-wrapper" style=" background-repeat:no-repeat;background: url(images/qd_s'+counter+'.png);  background-size: cover;height:'+wrapper[0].getAttribute('myheight')+';">\r\n';
            if (wrapper.find(".split-columns").length > 0) {
                ...
                wrapper.find("ul").each(function(i) {
                    ...
                    $(this).children("li").each(function(k) {
                     ...
                     //   html += perch + '        <li><div><a href="" title="" target="_blank"></a></div></li>' + '\r\n';
                    });
                    html += perch + '      </ul>' + '\r\n';
                });
                html += perch + '    </div>' + '\r\n';
            } else if (!wrapper.hasClass("ignore")) {
              //  var img = '<img name="49" class="banner" src="images/qd_s' + counter + '.png" alt="" />';
                var img ='';
    ...
    if ($(".outer-section").length > 0) {
        ...
        $(".outer-section").each(function(i) {
            ...
            if (wrapper.find(".split-columns").length > 0) {
                ...
                var img = '<img tt="117" class="banner' + split + '" src="images/qd_s' + counter + '.png" alt="" />';
