...
$().ready(function() {
   ...
   // console.log($(this).height()/45);
        wrapper[0].setAttribute("myheight",($(this).height()/45)+"rem");
...
var myscript='';
myscript +='	<script>   '+"\n";
myscript +='(function (doc, win) {'+"\n";
myscript +='        var docEl = doc.documentElement,'+"\n";
myscript +='            resizeEvt = "orientationchange" in window ? "orientationchange" : "resize",'+"\n";
myscript +='            recalc = function () {'+"\n";
myscript +='                var clientWidth = docEl.clientWidth;'+"\n";
myscript +='                if (!clientWidth) return;'+"\n";
myscript +='                if(clientWidth>=640){'+"\n";
myscript +='                    docEl.style.fontSize = "100px";'+"\n";
myscript +='                }else{'+"\n";
//myscript +='                    docEl.style.fontSize = 90 * (clientWidth / 640) + "px";'+"\n";
myscript +='                    docEl.style.fontSize = "14px"'+"\n";

myscript +='                }'+"\n";
myscript +='            };'+"\n";
myscript +='';
myscript +='        if (!doc.addEventListener) return;'+"\n";
myscript +='        win.addEventListener(resizeEvt, recalc, false);'+"\n";
myscript +='        doc.addEventListener("DOMContentLoaded", recalc, false);'+"\n";
myscript +='    })(document, window);'+"\n";
myscript +='</script> '+"\n";
    ...
    html += '    <meta name="viewport" content="width=device-width, initial-scale=1,user-scalable=no, minimal-ui">\r\n';
